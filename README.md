...
| Source | When used |
|--------|-----------|
| `tinkerer/INTERVIEW.md` | Pre-written answers organised by form field (see `INTERVIEW.md.example`) |
| `tinkerer/tinkerer-interview.md` | Generated by the interactive CLI interview (4 questions, editor-based input) |
