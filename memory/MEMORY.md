...
- **2026-03-31** — GRO-35: Added `--dry-run` / `-n` to `skills/tmux/scripts/find-sessions.sh` and `wait-for-text.sh` — validates flags and prints intent without requiring tmux or live sessions. Documented in `skills/tmux/SKILL.md`. Tests: `python3 -m unittest tests.test_tmux_scripts`.
