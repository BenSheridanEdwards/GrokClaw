...
- **2026-03-19** — Implemented GRO-23: Added tests for tmux scripts (`find-sessions.sh`, `wait-for-text.sh`). Created `tests/test_tmux_scripts.py` with 11 CLI validation tests; included tmux scripts in `tools/test-all.sh` shell syntax check.
